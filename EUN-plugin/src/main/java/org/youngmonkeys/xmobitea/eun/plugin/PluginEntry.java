 ...
 * 
 */
package org.youngmonkeys.xmobitea.eun.plugin;
...
public class PluginEntry extends EzyDefaultPluginEntry {
	...
	protected String[] getScanablePackages() {
		return new String[] {
			"org.youngmonkeys.xmobitea.eun.common",
			"org.youngmonkeys.xmobitea.eun.plugin"
		};
	}
}